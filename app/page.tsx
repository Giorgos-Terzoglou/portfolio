            ...
            >
              ...
              />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2">
                  ...
                  {/* RIGHT: BOOT → HERO */}
                  <div className="relative p-5 sm:p-7 md:p-12 border-t md:border-t-0 md:border-l border-white/10 pb-24">
                    <AnimatePresence mode="wait">
                      {phase === "boot" ? (
                        ...
                        >
                          ...
                          <div className="mt-4 sticky bottom-0 -mx-4 px-4 py-3 flex flex-wrap items-center gap-3 bg-transparent backdrop-blur-sm border-t border-white/10">
                            <button
